...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  executeProgram: (programPath: string) =>
    ipcRenderer.send('excute-program', programPath),
  onRequestSetProgramPath: (callback: () => void) =>
    ipcRenderer.on('request-set-program-path', callback),
